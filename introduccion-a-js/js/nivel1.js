...
//console.log("Buenas noches America!!!")
...
//const principal = "ALERTA MUNDIAL"
//alert(principal)
...
function preguntarNombre (nombrePersona = String(prompt("Cual es tu nombre?"))){
    if(nombrePersona === "Lautaro" || nombrePersona === "lautaro"){
...
function entrarAlBar(documento=String(prompt), añosDevida =Number(prompt("¿Cuantos años tienes?" ))){
